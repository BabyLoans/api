 ...
 */
final class Version20220317103241 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE rate (id INT NOT NULL, token_id INT NOT NULL, value DOUBLE PRECISION NOT NULL, is_current BOOLEAN NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_DFEC3F3941DEE7B9 ON rate (token_id)');
        $this->addSql('CREATE TABLE token (id INT NOT NULL, symbol VARCHAR(255) NOT NULL, color VARCHAR(255) NOT NULL, logo_url VARCHAR(255) DEFAULT NULL, is_active BOOLEAN NOT NULL, PRIMARY KEY(id))');
